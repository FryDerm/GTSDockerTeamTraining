<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoyaltySelectorControl.ascx.cs" Inherits="Gateway.WebStore.LoyaltySelectorControl" %>
<div id="LoyaltyPrograms" data-replace="LoyaltySelector">
	<asp:GridView ID="LoyaltyProgramGridView" runat="server" 
		...
		<Columns>
			<asp:TemplateField>
				<ItemTemplate>
					<div data-object-key="accounts" class="block">
